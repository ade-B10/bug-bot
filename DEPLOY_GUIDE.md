...
You're deploying to: `https://ade-B10.github.io/bug-bot/`
Password (save in 1Password under "Base10 · Bug-Bot Adversarial Reviewer"): `Base10Automation!`
...
2. In Finder, open `/Users/ade/Desktop/Urizen/bug-bot-deploy/`
...
`https://github.com/ade-B10/bug-bot/settings/pages`
...
1. Under "Build and deployment":
   ...
   - **Branch**: `main` / `/ (root)`
2. Click **Save**
3. Wait ~30 seconds. The page will show: "Your site is live at `https://ade-B10.github.io/bug-bot/`"
...
- Ask in Claude to "update Base10 · Bug-Bot Adversarial Reviewer with [the new info]"
- Claude will edit `source/Bug_Bot_Showcase.html`, run `./update.sh`, and tell you the exact commit message
- You just commit + push (or paste the new `index.html` into GitHub web UI)

**DIY path:**
1. Update `source/Bug_Bot_Showcase.html` directly (or have Claude do it)
2. In Terminal: `cd ~/Desktop/Urizen/bug-bot-deploy && ./update.sh`
