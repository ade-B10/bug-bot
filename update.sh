...
#
# Usage:
#   1. Put the updated unencrypted file at source/Bug_Bot_Showcase.html
...
SOURCE_FILE="source/Bug_Bot_Showcase.html"
OUTPUT_FILE="index.html"
LABEL="Base10 · Bug-Bot Adversarial Reviewer"
INSTRUCTIONS="Enter the password to access Base10 · Bug-Bot Adversarial Reviewer."
REMEMBER_DAYS=14
...
if [ ! -f "$SOURCE_FILE" ]; then
  ...
  echo "  mkdir -p source"
  echo "  cp /Users/ade/Desktop/Urizen/Bug_Bot_Showcase.html source/"
  echo ""
  exit 1
fi
...
sed -i.bak "s|<title>Protected Page</title>|<title>Base10 · Bug-Bot Adversarial Reviewer</title>|" "$OUTPUT_FILE"
...
echo "  git commit -m \"Refresh Base10 · Bug-Bot Adversarial Reviewer ($(date +%Y-%m-%d))\""
echo "  git push"
echo ""
