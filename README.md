# Base10 · Bug-Bot Adversarial Reviewer

Bug-Bot adversarial reviewer prototype. One of three agents in Base10's consensus-agents framework. Internal Base10.

**Live URL**: `https://ade-B10.github.io/bug-bot/`
...
2. Enter the team password (saved in 1Password under "Base10 · Bug-Bot Adversarial Reviewer")
...
```bash
cd /Users/ade/Desktop/Urizen/bug-bot-deploy

# 1. Drop the updated unencrypted HTML into source/
cp /Users/ade/Desktop/Urizen/Bug_Bot_Showcase.html source/
...
# 3. Commit and push
git add index.html
git commit -m "Refresh Base10 · Bug-Bot Adversarial Reviewer ($(date +%Y-%m-%d))"
git push
```
